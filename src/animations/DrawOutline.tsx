...
export const DrawOutlineButtonExample = () => {
    return <DrawOutlineButton>Hover me</DrawOutlineButton>
}
...
> = ({ children, ...rest }) => {
    return (
        <button
            {...rest}
            className="group relative px-4 py-2 font-medium transition-colors duration-[400ms] hover:text-indigo-500"
        >
            <span>{children}</span>
